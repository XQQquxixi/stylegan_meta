...
class LossModel:
    ...
    def build_loss_model(self, generated_image_tensor):
        ...
        self.loss = tf.losses.mean_squared_error(self.features_weight * self.ref_img_features, self.features_weight * generated_img_features) / 82890.0 + tf.losses.mean_squared_error(generated_image_tensor, self.ref_img)
